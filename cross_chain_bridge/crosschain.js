...
// Initialize the signer of the two chains
...
const main = async () => {
    try {
        console.log('Start monitoring cross-chain events')

        // Listen to the Bridge event of chain Sepolia,
        // then perform the mint operation on Goerli to complete the cross-chain
        contractSepolia.on("Bridge", async (user, amount) => {
            console.log(`Bridge event on Chain Sepolia: User ${user} burned ${amount} tokens`);
        
            // Perform mint operation on Goerli
        ...
        // Listen to the Bridge event of chain Goerli, then perform the mint operation on Sepolia to complete the cross-chain
        contractGoerli.on("Bridge", async (user, amount) => {
            console.log(`Bridge event on Chain Goerli: User ${user} burned ${amount} tokens`);

            // Execute mint operation on Sepolia
